...
public class GestorPersonas {
    ...
    Persona[] generarPersonas(int cantidad) {
        ...
        for (int i = 0; i < cantidad; i++) {
            ...
            int id = 1000 + i; // ID único secuencial
    ...
    void mostrarPersonas(String mensaje, Persona[] personas) {
    ...
    void probarTodosOrdenamientos(Persona[] personas) {
    ...
    void probarOrdenamiento(Persona[] personas, String metodo) {
    ...
    Persona[] ordenarParaBusqueda(Persona[] personas) {
    ...
    void buscarLineal(Persona[] personas, int edad) {
    ...
    void buscarBinaria(Persona[] personas, int edad) {
